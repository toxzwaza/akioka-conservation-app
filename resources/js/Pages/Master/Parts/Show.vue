...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-2xl space-y-6">
            ...
            <div class="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                <div class="px-4 py-3 bg-slate-50 border-b border-slate-200">
                    <h2 class="text-sm font-semibold text-slate-800">自分の表示名</h2>
                    <p class="text-xs text-slate-500 mt-1">品名・型番/品番を自分用に設定できます。未設定の項目はAPIの値が表示されます。</p>
                </div>
                <form @submit.prevent="submitDisplayName" class="p-4 space-y-4">
